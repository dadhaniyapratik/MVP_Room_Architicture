...
public final class FacetOption$TypeAdapter extends TypeAdapter<FacetOption> {
  public static final TypeToken<FacetOption> TYPE_TOKEN = TypeToken.get(com.vimeo.networking.model.search.FacetOption.class);

  private final Gson mGson;

  public FacetOption$TypeAdapter(Gson gson) {
    this.mGson = gson;
  }

  @Override
  public void write(JsonWriter writer, FacetOption object) throws IOException {
    if (object == null) {
      writer.nullValue();
      return;
    }
  ...
  @Override
  public FacetOption read(JsonReader reader) throws IOException {
