...
public final class VideoList$TypeAdapter extends TypeAdapter<VideoList> {
  public static final TypeToken<VideoList> TYPE_TOKEN = TypeToken.get(com.vimeo.networking.model.VideoList.class);
  ...
  public VideoList$TypeAdapter(Gson gson) {
    this.mGson = gson;
  ...
  @Override
  public void write(JsonWriter writer, VideoList object) throws IOException {
    if (object == null) {
      writer.nullValue();
      return;
    }
  ...
  @Override
  public VideoList read(JsonReader reader) throws IOException {
