...
public final class UserList$TypeAdapter extends TypeAdapter<UserList> {
  public static final TypeToken<UserList> TYPE_TOKEN = TypeToken.get(com.vimeo.networking.model.UserList.class);
  ...
  private final TypeAdapter<ArrayList<User>> mTypeAdapter2;

  public UserList$TypeAdapter(Gson gson) {
    this.mGson = gson;
    ...
    this.mTypeAdapter2 = new com.vimeo.stag.KnownTypeAdapters.ListTypeAdapter<com.vimeo.networking.model.User,java.util.ArrayList<com.vimeo.networking.model.User>>(mTypeAdapter1, new com.vimeo.stag.KnownTypeAdapters.ArrayListInstantiator<com.vimeo.networking.model.User>());
  }

  @Override
  public void write(JsonWriter writer, UserList object) throws IOException {
    if (object == null) {
      writer.nullValue();
      return;
    }
  ...
  @Override
  public UserList read(JsonReader reader) throws IOException {
