...
public class PresenterProvider {
    ...
    private static final String DEFAULT_KEY = "com.oeno.customer.ui.common.base.mvp.presenter.PresenterProvider.DefaultKey";
    ...
    /**
     * Returns an existing Presenter or creates a new one in the scope (usually, a typeFragment or
