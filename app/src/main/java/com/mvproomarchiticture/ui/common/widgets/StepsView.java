        ...
        if (mLabels != null) {
            for (int i = 0; i < mLabels.length; i++) {
                ...
                if (i == mCompletedPosition) {
                    textView.setTextColor(ResourcesCompat.getColor(getContext().getResources(),R.color.color_8895B3,null));
                } else {
                    textView.setTextColor(ResourcesCompat.getColor(getContext().getResources(),R.color.color_999896,null));
                }
