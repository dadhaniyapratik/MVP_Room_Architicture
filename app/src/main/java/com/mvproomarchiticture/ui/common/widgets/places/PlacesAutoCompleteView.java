package com.mvproomarchiticture.ui.common.widgets.places;
...
import com.mvproomarchiticture.ui.common.widgets.vector.VectorCompatViewHelper;
...
public class PlacesAutoCompleteView extends AppCompatAutoCompleteTextView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                delegate.setDebounce(ta.getInteger(R.styleable.PlacesAutoCompleteView_gac_debounce, PlacesAutoCompleteDelegate.DEBOUNCE));
                delegate.setMinStartSearch(ta.getInteger(R.styleable.PlacesAutoCompleteView_gac_min_start_search, PlacesAutoCompleteDelegate.MIN_START_SEARCH));
                delegate.setMaxResult(ta.getInteger(R.styleable.PlacesAutoCompleteView_gac_max_result, PlacesAutoCompleteDelegate.MAX_RESULT));
              //  delegate.setLayoutRes(ta.getResourceId(R.styleable.PlacesAutoCompleteView_gac_item_layout, android.R.layout.simple_dropdown_item_1line));
