...
public final class AlbumList implements com.vimeo.networking2.common.Pageable<com.vimeo.networking2.Album> {
    ...
    @org.jetbrains.annotations.Nullable()
    private final java.util.List<com.vimeo.networking2.Album> data = null;
    ...
    @org.jetbrains.annotations.Nullable()
    @java.lang.Override()
    public java.util.List<com.vimeo.networking2.Album> getData() {
        return null;
    }
    
    public AlbumList(@org.jetbrains.annotations.Nullable()
    ...
    java.util.List<com.vimeo.networking2.Album> data) {
        super();
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.util.List<com.vimeo.networking2.Album> component5() {
        return null;
    }
    ...
    public final com.vimeo.networking2.AlbumList copy(@org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "total")
    java.lang.Integer total, @org.jetbrains.annotations.Nullable()
    @com.squareup.moshi.Json(name = "page")
    java.lang.Integer page, @org.jetbrains.annotations.Nullable()
