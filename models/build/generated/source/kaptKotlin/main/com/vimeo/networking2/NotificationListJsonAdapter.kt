...
class NotificationListJsonAdapter(moshi: Moshi) : JsonAdapter<NotificationList>() {
    ...
    private val nullableListOfNotificationAdapter: JsonAdapter<List<Notification>?> =
            moshi.adapter<List<Notification>?>(Types.newParameterizedType(List::class.java, Notification::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(NotificationList)"

    override fun fromJson(reader: JsonReader): NotificationList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfNotificationAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: NotificationList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfNotificationAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
