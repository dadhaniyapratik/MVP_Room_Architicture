...
class VideoListJsonAdapter(moshi: Moshi) : JsonAdapter<VideoList>() {
    ...
    private val nullableListOfVideoAdapter: JsonAdapter<List<Video>?> =
            moshi.adapter<List<Video>?>(Types.newParameterizedType(List::class.java, Video::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(VideoList)"

    override fun fromJson(reader: JsonReader): VideoList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfVideoAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: VideoList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfVideoAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
