...
class LikeInteractionJsonAdapter(moshi: Moshi) : JsonAdapter<LikeInteraction>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(LikeInteraction)"

    override fun fromJson(reader: JsonReader): LikeInteraction {
    ...
    override fun toJson(writer: JsonWriter, value: LikeInteraction?) {
        if (value == null) {
