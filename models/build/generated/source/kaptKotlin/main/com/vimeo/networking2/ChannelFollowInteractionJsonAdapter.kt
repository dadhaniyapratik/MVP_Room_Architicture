...
class ChannelFollowInteractionJsonAdapter(moshi: Moshi) : JsonAdapter<ChannelFollowInteraction>() {
    private val options: JsonReader.Options =
            JsonReader.Options.of("added", "added_time", "options", "uri", "type")
    ...
    override fun toString(): String = "GeneratedJsonAdapter(ChannelFollowInteraction)"

    override fun fromJson(reader: JsonReader): ChannelFollowInteraction {
        ...
        reader.endObject()
        var result = ChannelFollowInteraction()
        result = result.copy(
    ...
    override fun toJson(writer: JsonWriter, value: ChannelFollowInteraction?) {
        if (value == null) {
