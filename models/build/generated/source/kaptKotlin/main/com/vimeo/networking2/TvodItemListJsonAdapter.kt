...
class TvodItemListJsonAdapter(moshi: Moshi) : JsonAdapter<TvodItemList>() {
    ...
    private val nullableListOfTvodItemAdapter: JsonAdapter<List<TvodItem>?> =
            moshi.adapter<List<TvodItem>?>(Types.newParameterizedType(List::class.java, TvodItem::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(TvodItemList)"

    override fun fromJson(reader: JsonReader): TvodItemList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfTvodItemAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: TvodItemList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfTvodItemAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
