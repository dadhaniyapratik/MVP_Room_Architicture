...
class WatchLaterInteractionJsonAdapter(moshi: Moshi) : JsonAdapter<WatchLaterInteraction>() {
    private val options: JsonReader.Options =
            JsonReader.Options.of("added", "added_time", "options", "uri")
    ...
    override fun toString(): String = "GeneratedJsonAdapter(WatchLaterInteraction)"

    override fun fromJson(reader: JsonReader): WatchLaterInteraction {
        ...
        reader.endObject()
        var result = WatchLaterInteraction()
        result = result.copy(
    ...
    override fun toJson(writer: JsonWriter, value: WatchLaterInteraction?) {
        if (value == null) {
