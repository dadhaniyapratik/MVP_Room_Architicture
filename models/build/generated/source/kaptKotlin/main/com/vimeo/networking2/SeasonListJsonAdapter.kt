...
class SeasonListJsonAdapter(moshi: Moshi) : JsonAdapter<SeasonList>() {
    ...
    private val nullableListOfSeasonAdapter: JsonAdapter<List<Season>?> =
            moshi.adapter<List<Season>?>(Types.newParameterizedType(List::class.java, Season::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(SeasonList)"

    override fun fromJson(reader: JsonReader): SeasonList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfSeasonAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: SeasonList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfSeasonAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
