...
class FollowInteractionJsonAdapter(moshi: Moshi) : JsonAdapter<FollowInteraction>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(FollowInteraction)"

    override fun fromJson(reader: JsonReader): FollowInteraction {
    ...
    override fun toJson(writer: JsonWriter, value: FollowInteraction?) {
        if (value == null) {
