...
class ProductListJsonAdapter(moshi: Moshi) : JsonAdapter<ProductList>() {
    ...
    private val nullableListOfProductAdapter: JsonAdapter<List<Product>?> =
            moshi.adapter<List<Product>?>(Types.newParameterizedType(List::class.java, Product::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(ProductList)"

    override fun fromJson(reader: JsonReader): ProductList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfProductAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: ProductList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfProductAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
