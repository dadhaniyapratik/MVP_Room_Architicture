...
class WatchedInteractionJsonAdapter(moshi: Moshi) : JsonAdapter<WatchedInteraction>() {
    ...
    override fun toString(): String = "GeneratedJsonAdapter(WatchedInteraction)"

    override fun fromJson(reader: JsonReader): WatchedInteraction {
    ...
    override fun toJson(writer: JsonWriter, value: WatchedInteraction?) {
        if (value == null) {
