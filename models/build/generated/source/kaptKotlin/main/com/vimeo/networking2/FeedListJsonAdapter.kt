...
class FeedListJsonAdapter(moshi: Moshi) : JsonAdapter<FeedList>() {
    ...
    private val nullableListOfFeedItemAdapter: JsonAdapter<List<FeedItem>?> =
            moshi.adapter<List<FeedItem>?>(Types.newParameterizedType(List::class.java, FeedItem::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(FeedList)"

    override fun fromJson(reader: JsonReader): FeedList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfFeedItemAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: FeedList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfFeedItemAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
