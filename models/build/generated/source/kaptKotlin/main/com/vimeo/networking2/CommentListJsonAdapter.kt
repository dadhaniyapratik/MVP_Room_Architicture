...
class CommentListJsonAdapter(moshi: Moshi) : JsonAdapter<CommentList>() {
    ...
    private val nullableListOfCommentAdapter: JsonAdapter<List<Comment>?> =
            moshi.adapter<List<Comment>?>(Types.newParameterizedType(List::class.java, Comment::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(CommentList)"

    override fun fromJson(reader: JsonReader): CommentList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfCommentAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: CommentList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfCommentAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
