...
class RecommendationListJsonAdapter(moshi: Moshi) : JsonAdapter<RecommendationList>() {
    ...
    private val nullableListOfRecommendationAdapter: JsonAdapter<List<Recommendation>?> =
            moshi.adapter<List<Recommendation>?>(Types.newParameterizedType(List::class.java, Recommendation::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(RecommendationList)"

    override fun fromJson(reader: JsonReader): RecommendationList {
        var total: Int? = null
        ...
        var data: List<Recommendation>? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfRecommendationAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: RecommendationList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfRecommendationAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
