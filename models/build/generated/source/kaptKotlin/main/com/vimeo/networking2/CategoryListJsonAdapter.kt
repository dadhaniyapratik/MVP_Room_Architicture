...
class CategoryListJsonAdapter(moshi: Moshi) : JsonAdapter<CategoryList>() {
    ...
    private val nullableListOfCategoryAdapter: JsonAdapter<List<Category>?> =
            moshi.adapter<List<Category>?>(Types.newParameterizedType(List::class.java, Category::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(CategoryList)"

    override fun fromJson(reader: JsonReader): CategoryList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfCategoryAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: CategoryList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfCategoryAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
