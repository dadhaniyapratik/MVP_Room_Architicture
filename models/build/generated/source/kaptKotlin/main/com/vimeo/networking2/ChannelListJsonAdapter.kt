...
class ChannelListJsonAdapter(moshi: Moshi) : JsonAdapter<ChannelList>() {
    ...
    private val nullableListOfChannelAdapter: JsonAdapter<List<Channel>?> =
            moshi.adapter<List<Channel>?>(Types.newParameterizedType(List::class.java, Channel::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(ChannelList)"

    override fun fromJson(reader: JsonReader): ChannelList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfChannelAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: ChannelList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfChannelAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
