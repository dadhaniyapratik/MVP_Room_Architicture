...
class AlbumListJsonAdapter(moshi: Moshi) : JsonAdapter<AlbumList>() {
    ...
    private val nullableListOfAlbumAdapter: JsonAdapter<List<Album>?> =
            moshi.adapter<List<Album>?>(Types.newParameterizedType(List::class.java, Album::class.java), kotlin.collections.emptySet(), "data")

    override fun toString(): String = "GeneratedJsonAdapter(AlbumList)"

    override fun fromJson(reader: JsonReader): AlbumList {
        var total: Int? = null
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                ...
                4 ->  {
                    data = nullableListOfAlbumAdapter.fromJson(reader)
                    dataSet = true
                }
                -1 -> {
    ...
    override fun toJson(writer: JsonWriter, value: AlbumList?) {
        if (value == null) {
        ...
        writer.name("data")
        nullableListOfAlbumAdapter.toJson(writer, value.data)
        writer.endObject()
    }
}
